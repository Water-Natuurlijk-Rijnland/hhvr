#!/bin/bash
# Wrapper script voor process-sliding-windows skill
# Dit script zorgt ervoor dat de juiste Python environment wordt gebruikt
...
# Execute the skill
cd "$PROJECT_ROOT"
exec "$PYTHON_CMD" "$PROJECT_ROOT/peilbesluiten/skills/process_sliding_windows_skill.py" "$@"
