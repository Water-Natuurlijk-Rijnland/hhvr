...
from .fetch_hydronet import HydronetGemaalDataFetcher, CHART_ID
import sys
sys.path.insert(0, str(Path(__file__).parent.parent))
from data_processing.sliding_window import process_gemaal_series

# Configuration
# Get project root (2 levels up from src/realtime/)
PROJECT_ROOT = Path(__file__).parent.parent.parent
OUTPUT_FILE = PROJECT_ROOT / "web/public/data/gemaal_status_latest.json"
GEOJSON_FILE = PROJECT_ROOT / "data/kaartlagen/Gemaal/Gemaal_layer0.geojson"
